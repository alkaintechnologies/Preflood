...
/*:
 * @plugindesc (v1.2) Animated Image Battle Commands.
 * @author Moghunter
 *
 * @param Mode
 * @desc Determines the command window mode.
 * 0 - Normal     1 - Ring Menu
 * @default 1
 *
 * @param Layout X-axis
 * @desc Determines layout X-Axis position.
 * @default 22
 *
 * @param Layout Y-axis
 * @desc Determines layout Y-Axis position.
 * @default 15 
 *
 * @param Com X-axis
 * @desc Determines command X-Axis position.
 * @default 0 
 *
 * @param Com Y-axis
 * @desc Determines command Y-Axis position.
 * @default 0 
 *
 * @param Arrow
 * @desc Enables/Disables the image of the arrow.
 * @default false
 *
 * @param Arrow X-axis
 * @desc Determines arrow X-Axis position.
 * @default 5
 *
 * @param Arrow Y-axis
 * @desc Determines arrow Y-Axis position.
 * @default 0
 *
 * @param Zoom Animation
 * @desc Enables/Disables zoom animations.
 * @default true
 *
 * @param Zoom Rate
 * @desc Determines zoom rate.
 * @default 1.30
 *
 * @param Zoom Speed
 * @desc Determines zoom velocity.
 * @default 0.015
 *
 * @param Zoom Loop
 * @desc Enables/Disables zoom loop animation.
 * @default true
 *
 * @param Slide Animation
 * @desc Enables/Disables slide animation.
 * @default false
 *
 * @param Slide X
 * @desc Slide distance setting X.
 * @default 0
 *
 * @param Slide Y
 * @desc Slide distance setting Y.
 * @default 0 
 *
 * @param Com Name
 * @desc Enables/Disables command name visibility.
 * @default true
 *
 * @param Com Name X-axis
 * @desc Command name X-Axis position.
 * @default 55
 *
 * @param Com Name Y-axis
 * @desc Command name Y-Axis position.
 * @default 75
 *
 * @param Com Font Size
 * @desc Determines command font size.
 * @default 22
 *
 * @param Cursor
 * @desc Enables/Disables cursor.
 * @default false
 *
 * @param Cursor X-axis
 * @desc Cursor X-Axis position.
 * @default 0
 *
 * @param Cursor Y-axis
 * @desc Cursor Y-Axis position.
 * @default 0
 *
 * @param Cursor Slide
 * @desc Enables/Disables cursor slide animation.
 * @default false 
 *
 * @param Row Max
 * @desc Determines the amount of visable commands.
 * @default 4 
 *
 * @param Ring Range
 * @desc Determines the range ring.
 * @default 70
 *
 * @param Ring Motion
 * @desc Enables/Disables ring motion animation.
 * @default true
 *
 * @param Pi Range
 * @desc Defines the Pi value range.
 * @default 2.0
 *
 * @param Side Input
 * @desc Enables/Disables side inputs to the right and left side.
 * @default true
 *
 * @param Face
 * @desc Enables/Disables face.
 * @default true
 *
 * @param Face X-axis
 * @desc X-Axis character face definition.
 * @default 0
 *
 * @param Face Y-axis
 * @desc Y-Axis character face definition.
 * @default -50 
 *
 * @help  
 * =============================================================================
 ...
 * =============================================================================
 * 
 * Animated Image Battle Commands.
 * This plugin requires MOG_BattleHud to work.
 *
 * =============================================================================
 * The images of the commands should be saved in the folder /img/battlecommands/ 
 ...
 * FACES
 * =============================================================================
 * To define the faces of the characters, name the following.
 * 
 * Face_ + Actor ID.png
 *
 * EG
 ...
 * HISTÓRICO
 * =============================================================================
 * (v1.2) - Crash Correction When Deactivating Arrow Function in Zero Mode.
 *        - Improved third party plugins compatibility.
 */
