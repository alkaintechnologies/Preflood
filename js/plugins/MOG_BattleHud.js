 ...
 *
 * @param Hud X-Axis
 * @desc Hud's X-Axis position definition.
 * @default -90
 *
 * @param Hud Y-Axis
 * @desc Hud's Y-Axis position definition.
 * @default 480
 *
 * @param Hud Space X
 ...
 * @desc Enable automatic adjustment based on Hud's 
 * position. (false - Defines the fixed position.)
 * @default false
 *
 * @param Max Battle Members
 * @desc Battler max amount in battle.
 * @default 3
 *
 ...
 * will be above the faces and gauges.
 * @default false
 *
 ...
 *
 * @param Turn X-Axis
 * @desc Position X-Axis position definition.
 * @default -20
 *
 * @param Turn Y-Axis
 * @desc Position Y-Axis position definition.
 * @default 17
 *
 ...
 * @desc Enable zoom animation when on.
 * @default true
 * 
 * @param >> FACE ===================
 * @desc 
 ...
 *
 * @param Face Visible
 * @desc Display face image.
 * @default true
 *
 * @param Face X-Axis
 * @desc Face X-Axis position definition.
 * @default 52
 *
 * @param Face Y-Axis
 * @desc Face Y-Axis position definition.
 * @default 44
 *
 * @param Face Shake Animation
 * @desc Enables/Disables Face Shake Animation.
 * @default true
 *
 * @param Face Zoom Animation
 * @desc Enables/Disables Face Zoom Animation.
 * @default true
 *
 * @param Face Frame Animation
 * @desc Sets animation frames rate.
 * 	  It is necessary to divide the image by 5.
 * @default false
 *
 * @param Face Priority
 * @desc Priority for the face. (0 Low - 1 High)
 * @default 1
 *
 * @param >> NAME ===================
 * @desc 
 ...
 *
 * @param Name X-Axis
 * @desc Name X-Axis position definition.
 * @default 75
 *
 * @param Name Y-Axis
 * @desc Name Y-Axis position definition.
 * @default 35 
 *
 * @param Name Align
 * @desc Alignment of the name.
 * 0 - Left  1 - Center   2 - Right
 * @default 0
 *
 * @param Name Font Size
 * @desc Defines the font size of the name.
 * @default 20
 *
 * @param Name Bold Size
 * @desc Determines font boldness.
 * (Basically character thikness)
 * @default 4
 *
 * @param Name Font Italic
 * @desc Enables/Disables font italic.
 * @default false
 *
 * @param >> HP ===================
 * @desc 
 ...
 * @desc Enables/Disables HP Meter
 * @default true   
 *
 * @param HP Meter X-Axis
 * @desc HP Meter X-Axis position definition.
 * @default 106
 *
 * @param HP Meter Y-Axis
 * @desc HP Meter Y-Axis position definition.
 * @default 40
 *
 * @param HP Meter Angle
 * @desc Determines HP Meter angle.
 * @default 0
 *
 * @param HP Meter Flow Anime
 * @desc Enables/Disables gradient animation on the meter.
